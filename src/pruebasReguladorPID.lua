...
OFF=0;ERROR=1;WARN=2;INFO=3;DEBUG=4                -- referencia para el log
...
--[[updateStatistics(PID)
    (table) PID:  tabla con los valores de la salida del regulador PID]]
...
while true do
  ...
  if os.time() >= cicloStamp then
    ...
    local postURL = postURL.."?key="..thingspeakKey.."&field1="..PID.newErr..
